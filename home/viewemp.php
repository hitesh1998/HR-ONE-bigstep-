      ...
      <div class="col-lg-4">
        <div class="card shadow-sm">
          <div class="card-header bg-transparent text-center">
            ...
            <h3><?php echo $rowd['First_Name'].' '. $rowd['Last_Name']; ?></h3>
          </div>
          <div class="card-body">
            <p class="mb-0"><strong class="pr-1">Employee ID :</strong><?php echo $rowd['Id'];?></p>
            <p class="mb-0"><strong class="pr-1">Email :</strong><?php echo $rowd['Email'];?></p>
            <form action="edit.php" method="POST">
            <p style="text-align: center;"><button class="btn btn-dark btn-sm" name="edit" value='<?php echo $rowd['Id'] ;?>' type="submit" <?php if ($_SESSION['email'] != 'hiteshgirish@ymail.com') { ?> hidden <?php } ?>>Edit</button></p>
            </form>
          </div>
        </div>
      </div>
          ...
          <div class="card-body pt-0">
            <table class="table table-bordered">
              <tr>
                ...
                <td width="2%">:</td>
                <td><?php echo $rowd['PhoneNu'];?></td>
              </tr>
              <tr>
                <th width="30%">Mentor Name	</th>
                <td width="2%">:</td>
                <td><?php echo $rowd['Mentor'];?></td>
              </tr>
              <tr>
                <th width="30%">Mentor Email</th>
                <td width="2%">:</td>
                <td><?php echo $rowd['Menter_email'];?></td>
              </tr>
              <tr>
                <th width="30%">Role</th>
                <td width="2%">:</td>
                <td><?php echo $rowd['Role'];?></td>
              </tr>
              <tr>
                <th width="30%">Gender</th>
                <td width="2%">:</td>
                <td><?php echo $rowd['Gender'];?></td>
              </tr>
            </table>
          </div>
        </div>
